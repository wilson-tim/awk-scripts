:
# Script to process NLPG updates in varying formats - specific to Cambs TRAINER.
...
DBMONEY=£
DBDATE=DMY4/
DBTEMP=/usr/universe/v8/DBTEMP/trainer
...
if [ -f $importlog ]
then
        mailit F david.hopkins@cambridge.gov.uk "NLPG 7.3 Trainer Imports `date`" $importlog
fi
