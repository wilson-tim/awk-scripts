...
ROOTDIR=C:/contender/version7
CYGROOT=c:/contender/version7
FGLDIR=C:/Contender/version7/FourJs/f4gl
...
## Update the trade Agrement value           
#echo "Processing trade contract values `date`" >> $MAILFILE
#cd $CCTDIR/TRADE
#$FGLRUN value_agree >> $MAILFILE

## Update the Trade Review dates             
#echo "Processing trade contract values `date`" >> $MAILFILE
#cd $CCTDIR/TRADE
#$FGLRUN trade_agmt_review >> $MAILFILE
...
#mailit F fiona@datapro.co.uk "Camden Overnight `date`" $MAILFILE
