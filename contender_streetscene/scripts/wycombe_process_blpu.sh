...
if [ -f $importlog ]
then
	mailit F richard.gosset@wycombe.gov.uk "BLPU Imports `date`" $importlog
	mailit F noreply@contender.wycombe.gov.uk "BLPU Imports `date`" $importlog
