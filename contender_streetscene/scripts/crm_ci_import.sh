...
export IMPORTDIR=/usr/universe/v7/IMPORTS/trainer/CRM
export CCTDIR=/usr/universe/v7/standard
export INFORMIXSERVER=islingto
...
export PATH=/usr/universe/v7/bin:/usr/universe/v7/standard/bin:/usr/universe/v7/bespoke/runners:/usr/universe/v7/standard/runners:/usr/universe/v7/standard/SCRIPTS:/usr/fgl2c/bin:/usr/informix/bin:/usr/universe/v7/bin:/usr/universe/v7/standard/bin:/usr/universe/v7/bespoke/runners:/usr/universe/v7/standard/runners:/usr/universe/v7/standard/SCRIPTS:/usr/fgl2c/bin:/bin:/usr/bin:/usr/local/bin:/usr/universe/bin:.:/usr/informix/bin:/usr/universe/bin

for crmfile in `ls $IMPORTDIR/*unl`
do
	echo $crmfile
	cd $CCTDIR/CRM
# ###########################################################################
