###############################################################################
#                                                                             #
# VIEW-CHANGES VERSION 0.02  (c) William Wragg 2000                           #
# BY WILLIAM WRAGG                                                            #
# DATE 15/09/2000                                                             #
#                                                                             #
...
BEGIN {
   ...
   print "###############################################################################"
   print "#                                                                             #"
   print "# VIEW-CHANGES VERSION 0.02  (c) William Wragg 2000                           #"
...
$1 == "find" {
   ...
   print "Number of records found: " records_found(search_criteria) 
