...
create table perm_plan (
	...
	plan_ref_code	char	(12)	not null,
	descript	char (1000),
	granted_date	date,
	rescind_date	date,
	perm_stat	char	(1),
...
create table ca_dets (
	...
	capital_sub_asset_	integer not null,
	notes	char	(50),
	charge_type	char	(6),
	...
	indexed_replacemen	money,
	depreciation_to_da	money,
	...
	asset_id	char	(6),
	property_id	integer,
	prev_capital_asset char (21),
	int_type	char	(2),
	prev_capital_sub_a	integer,
	asset_status	char	(2),
	residual_val_fld	money,
	apportionment_coun	integer,
        notes_extra char    (50),
	primary key (capital_asset_code,capital_sub_asset_));
...
create table blck_dets (
	...
	const_type	char	(4),
	l_upgrade_date	date,
	upgrade_text	char (1000),
	blck_text	char (1000),
	disabled_access	char (1000),
	net_space_sqm	money,
	net_int_sqm	money,
	bal_area_sqm	money,
	other_area	money,
...
create table setup (
	...
	usr	char	(1),
	initialise	char (1000),
	err_message	char (1000));
...
create table ph_hist (
	...
	date_act_resp	date,
	time_resp	datetime hour to minute,
	time_resp_a	money	(4),
	tot_hours_resp	money	(6),
	time_comp	datetime hour to minute,
	time_comp_a	money	(4),
	...
	reported_by	char	(24),
        ...
        time_reported    	datetime hour to minute);
...
create table helpdesk (
	...
	work_done	char	(40),
	time_completed	datetime hour to minute,
	date_completed	date);
...
create table div_dets (
	committee_or_divis char (4) not null primary key,
	descript	char	(24));
...
create table art_works (
	...
	live_flag_date	date,
	locat_block	char	(1),
	locat_desc	char (1000),
	obvious_damage	char (1000),
	provenance	char (1000),
	visitor	char	(20),
	work_name	char (1000),
...
create table asset_pro (
	...
	how_resolved	char (1000),
	illegal_dumping	char (1000),
...
create table deed_dets (
	...
	rent_rev_desc	char (1000),
	review_per_mth	integer,
	review_per_yr	integer,
	road_own	char	(30),
	road_prop	char	(30),
	tenant_repair	char (1000),
	time_critical	char	(1),
	title_nat_desc	char (1000),
	town_own	char	(25),
	town_prop	char	(25),
	usr_clause	char	(1),
	usr_clause_desc	char (1000),
...
create table land_surv (
	...
	site_area	float	(64),
	build_comments	char (1000),
	car_park_area	integer,
	date_measured	date,
	dev_factors	char (1000),
	electricity	char	(1),
	fencing_cond	char	(4),
	foul_water_mains	char	(1),
	foul_water_plant	char	(1),
	gas	char	(1),
	gen_comments	char (1000),
	...
	oil_heating	char	(1),
	ped_access	char	(1),
	ped_access_desc	char (1000),
	site_desc	char (1000),
	surveyor_name	char	(20),
	telephone	char	(1),
	veh_access_desc	char (1000),
...
create table restr_dets (
	...
	level_7_code	char	(20),
	level_number	integer,
	tree_pres_order	char (1000),
	oth_t_plan_info	char (1000),
	geo_min_wat_sew	char (1000),
	bound_type_resp	char (1000),
	disp_land_detail	char (1000),
	add_details	char (1000),
	puswa_not_iss_rec	char (1000),
	land_consrv_area	char (1000),
	protected_specs	char (1000),
	other_use_1	char (1000),
	other_use_2	char (1000),
	access_to_land	char (1000));
...
create table occupancy (
	...
	level_7_code	char	(20),
	level_number	integer,
	leasehold_covenant char (1000),
	other_lease_detail char (1000),
	current_annual_ren	money,
	rent_due_date	date,
...
create table ratings (
	...
	level_number	integer,
	lifts	char	(1),
	modern_c_heat	char (1000),
	mkt_rent_prev	char (1000),
	modern_a_cond	char (1000),
	...
	other_use	char (1000),
	other	char (1000),
	plant_machine_t	char (1000),
	play_f_tenn_c	char (1000),
...
create table alt_st_dts (
	...
	gas_service_dets	char (1000),
	elec_sup_l_office	char	(8),
	elec_serv_dets	char (1000),
	water_sup_l_office	char	(8),
	water_serv_dets	char (1000),
	dr_auth_l_office	char	(8),
	dr_arrangement	char (1000),
	oth_sup_name_1	char	(8),
	oth_sup_dets_1	char (1000),
	oth_sup_name_2	char	(8),
	oth_sup_dets_2	char (1000),
	...
	exist_use_des	char (1000),
	land_val_pres_use	money,
	present_use_dt	date,
	pot_use_desig	char (1000),
	land_val_pot_use	money,
	pot_use_date	date,
	non_domestic_rv	money,
	non_dom_date	date,
	exist_consent	char (1000),
...
create table trans_log (
	...
	transfer_date	date,
	primary key (capital_asset_code,capital_sub_asset_,run_type));
...
create table dist_plan (
	...
	other_desc	char (1000),
	other_policy	char	(1),
	p_build_policy	char	(1),
	plan_title	char (1000),
	rec_policy	char	(1),
...
create table ap_dels (
	...
	percentage	money	(3),
	donated	char	(1)	not null,
	primary key (capital_asset_code,capital_sub_asset_,division,management_unit,cost_centre,account_code,donated));
