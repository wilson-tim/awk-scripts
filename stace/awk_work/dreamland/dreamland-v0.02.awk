###############################################################################
#                                                                             #
# DREAMLAND VERSION 0.02  (c) William Wragg 2000                              #
# BY WILLIAM WRAGG                                                            #
# DATE 18/08/2000                                                             #
#                                                                             #
...
function chop(_string, _size,    _count, _begin_at, _char, _last_space, _line) {
   ...
   for (_line = 1; _line > 0; _line++ ) {
      ...
      location_array[_line] = pad(substr(_string, _begin_at, _last_space - _begin_at), " ", _size)
