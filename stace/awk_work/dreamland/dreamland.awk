###############################################################################
#                                                                             #
# DREAMLAND VERSION 0.08  (c) William Wragg 2000                              #
# BY WILLIAM WRAGG                                                            #
# DATE 18/08/2000                                                             #
#                                                                             #
...
# This function pads the help strings and outputs them as a numbered array into
# a global variable. Outputs the size of this array in another global variable.
function create_help_array(_size) {   # Local Variables
   _size = 0
   while ((getline < "dreamland.hlp") > 0 ) {
      if ($0 !~ /^#/) {
         _size++ 
         help_array[_size] = pad($0, " ", 73) 
      }
   }
   help_array_size = _size
   close("dreamland.hlp")
}
...
# This function deals with the help printing
function help_print(_line) {   # Local Variables
   print "  ___________________________________________________________________________  "
   print "||                                                                           ||"
   for (_line = 1; _line <= help_array_size; _line++) {
      print "|| " help_array[_line] " ||"
   }
   print "||___________________________________________________________________________||"
}
